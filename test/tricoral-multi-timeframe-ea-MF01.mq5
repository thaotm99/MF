...
// KHONG thay the. Comment day du dang "MF_01, ATR: x.x, erK: x.xx, er: x.xx" (xem OpenOrder)
...
//    (trade.SetExpertMagicNumber trong OnInit) + comment dạng "MF_01, ATR: x.x, erK: x.xx,
