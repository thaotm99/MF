...
// KHONG thay the. Comment day du dang "MF_03, ATR: x.x, erK: x.xx, er: x.xx" (xem OpenOrder)
...
//    (trade.SetExpertMagicNumber trong OnInit) + comment dạng "MF_03, ATR: x.x, erK: x.xx,
...
//    + đang mở) > InpTimeWindowMaxProfit ($70), bot NGỪNG mở lệnh mới đến khi sang khung
