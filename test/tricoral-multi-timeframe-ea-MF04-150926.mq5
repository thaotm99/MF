...
// KHONG thay the. Comment day du dang "MF_04, ATR: x.x, erK: x.xx, er: x.xx" (xem OpenOrder)
...
//    (trade.SetExpertMagicNumber trong OnInit) + comment dạng "MF_04, ATR: x.x, erK: x.xx,
