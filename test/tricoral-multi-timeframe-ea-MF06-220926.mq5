...
// KHONG thay the. Comment day du dang "MF_06,A: x.x,ek: x.xx,er: x.xx" (xem OpenOrder)
#define BOT_COMMENT_PREFIX "MF_06"
...
//    (trade.SetExpertMagicNumber trong OnInit) + comment dạng "MF_06,A: x.x,ek: x.xx,
//    er: x.xx" (BOT_COMMENT_PREFIX = "MF_06", xem OpenOrder). Mọi thao tác trail/đóng lệnh
//    đều đi qua IsBotPosition() để chỉ đụng tới lệnh có magic này VÀ comment bắt đầu bằng
//    "MF_06", không đụng vào lệnh thủ công.
